...
- [Tentacle (client patch)](https://git.xeondev.com/yidhari-zs/Tentacle)
...
### Logging in
Currently supported client version is `CNBetaWin2.6.4`, you can get it from 3rd party sources.

Next, you have to apply the necessary [client patch](https://git.xeondev.com/yidhari-zs/Tentacle). It allows you to connect to the local server and replaces encryption keys with custom ones.

As the last step, you need to run [KCPShim](https://git.xeondev.com/xeon/kcpshim). It acts like a middleman, translating packets sent between client and server over KCP to TCP and vice versa.
